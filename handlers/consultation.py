...
async def send_consultation_waitlist(
    ...
    text = (
        "Свободных окон в расписании сейчас нет.\n\n"
        "Чтобы попасть в лист ожидания, нажмите кнопку ниже 👇🏼 и "
        "напишите моему ассистенту, вас внесут в список и обязательно "
        "свяжутся с вами, как только появится место.\n\n"
        "Спасибо за терпение, буду рада видеть вас на консультации"
    )
