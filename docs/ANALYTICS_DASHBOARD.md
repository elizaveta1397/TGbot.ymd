...
- **Вовлечённость** — вне воронки Cinemalogy: кнопки главного меню
  («Обо мне» — `menu_about_me`, «12 колыбельных» — `menu_lullabies`)
  и запись на консультацию (`consultation_request`, общая для входа
  через меню и через инлайн-кнопку со старта Cinemalogy) — уникальных
  пользователей и всего срабатываний на каждое событие
